...
export function setCartTotal() {
  ...
  const headerCartTotal=document.querySelector('.header-cart-total') as HTMLElement
  ...
  const headerCartCounter=document.querySelector('.header-cart__counter') as HTMLElement
